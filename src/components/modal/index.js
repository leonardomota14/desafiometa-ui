...
export class Modal {
  ...
  addForm() {
    ...
    $("#modalContent").append(` 
      <form id="formRegister" class="col s12">
        ...
        <div class="row">
          <div class="input-field col s6">                
            <select id="sexo">
              <option value="NAO_INFORMADO" disabled selected></option>
    ...
    $("#modalBtn").append(`
      <div id="btnSave" class="btn waves-effect waves-light waves-effect teal waves-teal">Salvar</div>`);
  ...
  loadForm() {
    ...
    $.ajax({
      type: "GET",
      url: `https://desafiometa-api.herokuapp.com/pessoas/${this.data}`,
      headers: {
        Authorization: "Basic " + btoa("meta" + ":" + "meta"),
      },
  ...
  saveRegister() {
    ...
    $.ajax({
      url: `https://desafiometa-api.herokuapp.com/pessoas/${id}`,
      method: that.method,
      timeout: 0,
      headers: {
        Authorization: "Basic " + btoa("meta" + ":" + "meta"),
